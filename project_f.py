...
/**
 * @file Project.py 
 * @The goal of the project is to analyse the data set
...
#######----------------------------data analysis--------------------------#######
####Q1: (a) Specifying the demographic and population among the (1) Organization Group (2) Department Code (3) Department,
